...
public class BeatmapFilter implements IsSerializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (direction != other.direction)
      return false;
    if (expectedPP == null) {
      if (other.expectedPP != null)
        return false;
    } else if (!expectedPP.equals(other.expectedPP))
      return false;
    if (mapLength == null) {
      if (other.mapLength != null)
        return false;
    } else if (!mapLength.equals(other.mapLength))
      return false;
    if (oD == null) {
      if (other.oD != null)
        return false;
      ...
      return false;
    if (perfectPP == null) {
      if (other.perfectPP != null)
        return false;
    } else if (!perfectPP.equals(other.perfectPP))
      return false;
    if (rankedOnly != other.rankedOnly)
      return false;
    if (searches == null) {
    ...
    if (sortBy != other.sortBy)
      return false;
    if (starDiff == null) {
      if (other.starDiff != null)
        return false;
    } else if (!starDiff.equals(other.starDiff))
      return false;
    return true;
  }
