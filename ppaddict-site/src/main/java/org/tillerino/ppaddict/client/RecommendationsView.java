...
public class RecommendationsView extends AbstractBeatmapTable {
    ...
    private static RecommendationsViewUiBinder uiBinder = GWT.create(RecommendationsViewUiBinder.class);
    ...
    protected void hideRecommendation(final int index, Beatmap object) {
        ...
        recommendations.hideRecommendation(object.beatmapid, object.mods, new AbstractAsyncCallback<Beatmap>() {
            @Override
