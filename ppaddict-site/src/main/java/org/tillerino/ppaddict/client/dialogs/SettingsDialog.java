...
public class SettingsDialog extends AbstractSettingsDialog {
    ...
    public void showHelp(HelpElements elements) {
        if (userData.isOsuName) {
            elements.positionAndShow(
                    E.SETTINGS_RECOMMENDATIONS, recommendationsSettingsRow.getElement(), Side.RIGHT_BELOW, null);
        } else {
            elements.positionAndShow(E.SETTINGS_LINK, linkOsuAccount.getElement(), Side.RIGHT_BELOW, null);
        }
    }
}
