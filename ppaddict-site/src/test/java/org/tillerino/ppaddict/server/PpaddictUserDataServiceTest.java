...
public class PpaddictUserDataServiceTest extends AbstractPpaddictTest {
    ...
    public void testServerUserData() throws Exception {
        ...
        assertThat(userDataService.loadUserData("id:identifier")).hasValueSatisfying(loaded -> assertThat(loaded)
        ...
        userDataService.saveUserData("id:identifier", userData);
        assertThat(userDataService.loadUserData("id:identifier")).hasValueSatisfying(loaded -> assertThat(loaded)
                .hasFieldOrPropertyWithValue("settings.highAccuracy", 98D));
    }
