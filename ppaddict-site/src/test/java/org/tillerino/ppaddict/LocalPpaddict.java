...
public class LocalPpaddict {
    ...
    .setHandler(PpaddictModule.createGuiceFilterPathHandler(new GuiceServletContextListener() {
			@Override
	...
	@dagger.Module(includes = {LocalConsoleTillerinobot.Module.class, TestClock.Module.class, FakeAuthenticatorService.Module.class})
	interface Module {
		@dagger.Provides
		...
		@dagger.Provides
		@Singleton
		static PpaddictUserDataService getPpaddictUserDataService(DatabaseManager linkKeys, Clock clock,
