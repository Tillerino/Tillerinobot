...
public class RabbitMqContainer {
    ...
    private static final ReusableContainerInitializer<RabbitMQContainer> initializer =
            new ReusableContainerInitializer<>(RABBIT_MQ, container -> assertThat(container
                            .execInContainer("rabbitmqadmin", "declare", "vhost", "name=" + VIRTUAL_HOST)
                            .getExitCode())
                    .isZero());
