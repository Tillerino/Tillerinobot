...
public class NumericPropertyPredicateTest {
	...
	public void testContradiction() throws Exception {
		RecommendationPredicate predicate1 = new NumericPropertyPredicate<>("w/e", new TitleLength(), 2, 5);

		RecommendationPredicate predicate2 = new NumericPropertyPredicate<>("w/e", new TitleLength(), 6, 7);
