...
/**
 * We want to handle events in parallel, but we don't want to drain the queue and put everything into the queue of the
 * thread pool. See comments below for more details.
 */
@Slf4j
@Singleton
