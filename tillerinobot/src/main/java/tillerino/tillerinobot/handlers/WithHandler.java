...
public class WithHandler implements CommandHandler {
    ...
    public GameChatResponse handle(String originalMessage, OsuApiUser apiUser, UserData userData, Language lang)
        ...
        BeatmapMeta beatmap = diffEstimateProvider.loadBeatmap(lastSongInfo.beatmap(), mods);
        if (beatmap == null) {
        ...
        return new Message(beatmap.formInfoMessage(false, true, null, userData.getHearts(), null, null, null))
