 ...
 * https://osu.ppy.sh/users/8488688
 */
public class Polish extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "Nieznana komenda \"" + command + "\". Napisz !help jeśli potrzebujesz pomocy!";
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return "Wybacz, nie wiem co oznacza \"" + invalid + "\". Spróbuj: " + choices + "!";
    }
