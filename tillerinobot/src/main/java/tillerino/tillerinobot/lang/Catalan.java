...
public class Catalan extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "Comandament desconegut \"" + command + "\". Escriu !help si necessites ajuda!";
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return "Ho sento, però \"" + invalid + "\" no existeix. Prova el següent: " + choices + "!";
    }
    ...
    public String apiTimeoutException() {
        ...
        final String message =
                "Els servidors de osu! estan molt lents ara mateix, pel que no puc ajudar-te amb res a hores d'ara. ";
        return message
