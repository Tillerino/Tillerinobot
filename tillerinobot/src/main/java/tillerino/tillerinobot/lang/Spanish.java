...
public class Spanish extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "comando desconocido \"" + command + "\". ¡Escribe !help si necesitas ayuda!";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message("¡Ven aquí!").then(new Action("Abraza a " + apiUser.getUserName()));
    }
    ...
    public String featureRankRestricted(String feature, int minRank, OsuApiUser user) {
        return "Lo siento, actualmente " + feature + " está solo disponible para jugadores que hayan superado el rango"
                + minRank + ".";
    }
    ...
    public GameChatResponse optionalCommentOnLanguage(OsuApiUser apiUser) {
        return new Message(
                "Sasakura, Underforest y [https://osu.ppy.sh/u/2743036 Zarkinox] me ayudaron a aprender español :3");
    }

    @Override
    public String invalidChoice(String invalid, String choices) {
        return "Lo siento, pero \"" + invalid + "\" no computa. Prueba estos: " + choices + "!";
    }
    ...
    public String apiTimeoutException() {
        ...
        final String message =
                "Los servidores de osu! están muy lentos ahora mismo, por lo que no puedo ayudarte con nada en estos momentos. ";
        return message
