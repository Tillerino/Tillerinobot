...
public class TsundereEnglish extends TsundereBase {
    ...
    public String internalException(String marker) {
        return "Huh? Why isn't this working? I can't imagine this being anything other than your fault."
                + " Mention incident " + marker
                + " to [https://twitter.com/Tillerinobot @Tillerinobot] or [http://www.reddit.com/user/tillerino /u/Tillerino] if this keeps happening.";
    }
    ...
    public String externalException(String marker) {
        return "Sorry, the osu! server was saying some idiotic nonsense and I felt like slapping them instead of you. Try asking whatever it was again."
                + " If the server doesn't shut up, ask [https://twitter.com/Tillerinobot @Tillerinobot] or [http://www.reddit.com/user/tillerino /u/Tillerino] (reference "
                + marker + ") to take care of it.";
    }
    ...
    public String noInformationForModsShort() {
        ...
        return noInformationForModsShortShuffler.get("Those mods? You wish!", "Mods? What mods?", "Nomod loves you");
    }
    ...
    public String unknownCommand(String command) {
        return command
                + "? I think you've got the hierarchy backwards. You do what I tell you, and I respond if I feel like it. Type !help if you're too stupid to even tell what I want.";
    }
    ...
    protected GameChatResponse getHugResponseForHugLevel(String username, int hugLevel) {
        return switch (hugLevel) {
            case 0 -> new Action("slaps " + username).then(new Message("Sorry, that was just a reflex."));
            case 1 ->
                new Action("hugs " + username).then(new Message("Wow, you suck at hugs. Someone needs to teach you."));
            case 2 ->
                new Message("There's something on your back, you slob. Here, let me get that.")
                        .then(new Action("hugs " + username));
            case 3 ->
                new Action("hugs " + username)
                        .then(
                                new Message(
            ...
            case 4 ->
                new Action("hugs " + username)
                        .then(new Message(
                                "The hardest part of hugging you is letting go. I think you sweat too much."));
            case 5 ->
                new Action("slaps " + username).then(new Message("Whoops... well, you probably deserved it anyways."));
            case 6 ->
                new Action("hugs " + username)
                        .then(new Message("Don't misunderstand, it's not like I like you or anything..."));
            case 7 ->
                new Message("Clinginess is considered a bad thing, you idiot.").then(new Action("hugs " + username));
            case 8 ->
                new Message("S-stupid. It's l-like you enjoy hugging me or something.")
                        .then(new Action("hugs " + username));
            case 9 -> new Action("hugs " + username).then(new Message("Don't forget: you're here forever."));
            case 10 ->
                new Action("slaps " + username + " hard")
    ...
    protected GameChatResponse getOptionalCommentOnRecommendationResponse(int recentRecommendations) {
        return switch (recentRecommendations) {
            ...
            case 173 ->
                new Message("Just can't leave me alone, huh? I guess t-that's okay. But don't you dare tell anyone!");
    ...
    protected String getInvalidChoiceResponse(String invalid, String choices) {
        return "What does \"" + invalid
                + "\" even mean!? If using two fingers is too much, try singletapping each letter: " + choices;
    }
