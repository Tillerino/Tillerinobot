...
public class Czech extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "neznámý příkaz \"" + command + "\". Zadej !help pokud potřebuješ pomoc!";
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return "Omlouvám se, ale \"" + invalid + "\" se nepočítá. Zkus tyto: " + choices + "!";
    }
    ...
    public String apiTimeoutException() {
        ...
        final String message =
                "V tuto chvíli jsou osu! servery super pomalé, takže pro tuto chvíli nemůžu nic pro tebe udělat. ";
        return message
