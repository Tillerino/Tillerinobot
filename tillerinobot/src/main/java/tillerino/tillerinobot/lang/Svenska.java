...
public class Svenska extends AbstractMutableLanguage {
    ...
    public GameChatResponse welcomeUser(OsuApiUser apiUser, long inactiveTime) {
        if (inactiveTime < 60 * 1000) {
            ...
            return new Message(apiUser.getUserName() + "...")
                    ...
                    .then(new Message(
                            "Det känns bra att du är tillbaka. Kan jag intressera dig med en rekommendation?"));
        } else {
            String[] messages = {
    ...
    public String unknownCommand(String command) {
        return "Ogiltigt kommando \"" + command + "\". Skriv !help om du behöver hjälp!";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message("Kom hit, du!").then(new Action("kram " + apiUser.getUserName()));
    }
    ...
    public GameChatResponse optionalCommentOnLanguage(OsuApiUser apiUser) {
        return new Message(
                "[https://osu.ppy.sh/u/3258429 SnickarN] och [https://osu.ppy.sh/u/8116579 Padnezz] hjälpte mig att lära mig svenska!");
    }

    @Override
    public String invalidChoice(String invalid, String choices) {
        return "Förlåt, men \"" + invalid + "\" beräknas inte. Testa dessa: " + choices + "!";
    }
