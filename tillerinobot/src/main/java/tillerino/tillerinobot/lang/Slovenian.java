...
public class Slovenian extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "Neznan ukaz \"" + command + "\". Napiši !help če potrebuješ pomoč!";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message("Pridi sem!").then(new Action("objame " + apiUser.getUserName()));
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return "Žal mi je, ampak \"" + invalid + "\" ni veljaven vnos. Poskusi to: " + choices + "!";
    }
