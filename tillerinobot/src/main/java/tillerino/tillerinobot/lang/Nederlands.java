...
/**
 * Dutch language implementation by https://osu.ppy.sh/u/PudiPudi and https://github.com/notadecent and
 * https://osu.ppy.sh/u/2756335
 */
public class Nederlands extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "Ik snap niet helemaal wat je bedoelt met \"" + command + "\". Typ !help als je hulp nodig hebt!";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message("Kom eens hier jij!").then(new Action("knuffelt " + apiUser.getUserName()));
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return "Het spijt me, maar \"" + invalid + "\" werkt niet. Probeer deze: " + choices + "!";
    }
