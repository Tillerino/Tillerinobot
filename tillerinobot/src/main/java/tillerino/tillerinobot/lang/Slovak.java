...
public class Slovak extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "neznámý príkaz \"" + command + "\". Napíš !help pokiaľ potrebuješ pomoc!";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message("Poď sem, ty!").then(new Action("objíma " + apiUser.getUserName()));
    }
    ...
    public String featureRankRestricted(String feature, int minRank, OsuApiUser user) {
        return "Je mi ľúto, ale v tejto chvíli " + feature + " je sprístupnená len pre hráčov, ktorí prekonali rank "
                + minRank + ".";
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return "Prepáč, ale \"" + invalid + "\" sa nepočítá. Skús tieto: " + choices + "!";
    }
