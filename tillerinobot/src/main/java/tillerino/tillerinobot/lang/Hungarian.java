...
public class Hungarian extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "Ismeretlen parancs: \"" + command + "\". Írd be azt hogy \"!help\" ha kiváncsi vagy a parancslistára!";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message("Gyere ide!").then(new Action("megöleli " + apiUser.getUserName() + "t"));
    }
    ...
    public GameChatResponse optionalCommentOnLanguage(OsuApiUser apiUser) {
         ...
         */
        return new Message(
                "Kicsit nehéz volt megtanulni... de megcsináltam! (fordító: [https://osu.ppy.sh/u/BakaHarcos BakaHarcos], [https://osu.ppy.sh/u/10148621 skiilaa])");
    }

    @Override
    public String invalidChoice(String invalid, String choices) {
        return "Bocsi, de az hogy \"" + invalid + "\" nem logikus. Próbáld meg: " + choices + "!";
    }
    ...
    public String apiTimeoutException() {
        ...
        final String message =
                "Az osu! szerverek naaagggyyyooonnn lasssúúúaaakkk, úgyhogy most nem sok dolgot tudok csinálni. ";
        return message
