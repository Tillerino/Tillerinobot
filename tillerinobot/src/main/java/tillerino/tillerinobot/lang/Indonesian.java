...
public class Indonesian extends AbstractMutableLanguage {
    ...
    public GameChatResponse welcomeUser(OsuApiUser apiUser, long inactiveTime) {
        if (inactiveTime < 60 * 1000) {
            ...
            return new Message(apiUser.getUserName() + "...")
                    ...
                    .then(
                            new Message(
                                    "Senang bisa menemuimu kembali. Bisakah saya menarik minat anda dalam sebuah rekomendasi?"));
        } else {
            String[] messages = {
    ...
    public String unknownCommand(String command) {
        return "Perintah tidak diketahui \"" + command + "\". Ketik !help jika kau butuh bantuan!";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message("Sini, kau!").then(new Action("memeluk " + apiUser.getUserName()));
    }
    ...
    public String featureRankRestricted(String feature, int minRank, OsuApiUser user) {
        return "Maaf, sampai saat ini " + feature + " hanya dapat dipakai untuk pengguna yang telah melewati peringkat "
                + minRank + ".";
    }
    ...
    public GameChatResponse optionalCommentOnLanguage(OsuApiUser apiUser) {
         ...
         */
        return new Message(
                "Halo! [https://osu.ppy.sh/u/3925053 Rumberkren] dan [https://osu.ppy.sh/u/3378391 Error-] membantuku mempelajari Bahasa Indonesia");
    }

    @Override
    public String invalidChoice(String invalid, String choices) {
        return "Maaf, tapi \"" + invalid + "\" tidak bisa diperhitungkan. Cobalah ini: " + choices + "!";
    }
    ...
    public String apiTimeoutException() {
        ...
        final String message =
                "Server osu! sedang sangat lambat sekarang, jadi tidak ada yang bisa saya lakukan sekarang. ";
        return message
