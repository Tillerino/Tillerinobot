...
/**
 * Implementations of this interface will be instantiated once per user to allow for shuffling of messages, counters and
 * time delay measurements. They will also be persisted. This is why implementations need to be kept very lightweight.
 *
 * <p>Persisting the object works as follows: the bot asks {@link #isChanged()}, and if true, persists the object, and
 * calls {@link #setChanged(boolean)} with false.
 *
 * @author Tillerino
 */
public interface Language {
    ...
    /**
     * An internal exception occurred and has been logged with a marker. The message here should indicate to contact
    ...
    /**
     * An exception occurred while communicating with the osu api and has been logged with a marker. The message here
     * should indicate that this is no cause for concern and to try again, but to contact Tillerino via Twitter
    ...
    /**
     * Welcome a donator who has been offline. This can include multiple messages and even actions.
     *
    ...
    /**
     * Short string to suggest to try this recommendation with the given mods if the song info doesn't include that
    ...
    /**
     * Donator mentioned hug or hugs. Response can include multiple messages or even actions.
     *
     ...
     *
     * @return a message which indicates that the correct format is set option value
     */
    String setFormat();
