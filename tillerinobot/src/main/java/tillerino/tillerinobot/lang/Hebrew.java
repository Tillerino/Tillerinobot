...
public class Hebrew implements Language {
    ...
    public String internalException(String marker) {
        return "@Tillerino או /u/Tillerino. (שגיאה: " + marker + ")"
                + "אע.. טילרנו עשה משהו לא במקום, אם הוא לא ישים לב, תוכל ליידע אותו?";
    }

    @Override
    public String externalException(String marker) {
        return "טילרנו אומר שזה בסדר גמור.. נסה שוב מאוחר יותר ותיידע אותו דרך טוויטר @Tillerino או דרך /u/Tillerino. (שגיאה: "
                + marker + ")" + "מה קורה פה? אני מקבל חוסר הגיון משרת האוסו. מה זה אומר? 0011101001010000";
    }
    ...
    @Override
    public String help() {
        return "!בשביל פקודות https://github.com/Tillerino/Tillerinobot/wiki בדוק את"
                + " !בשביל עדכוני מצב ועדכונים https://twitter.com/Tillerinobot בדוק את "
                + ".ולקח את המשתמש שלו. סתם צוחק, אבל אני עדיין משתמש לו בחשבון Tillerino היי! אני הרובוט שהרג את ";
    }
