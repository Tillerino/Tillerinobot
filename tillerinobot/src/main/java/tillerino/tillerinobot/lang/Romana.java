...
public class Romana extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "Comandă necunoscută \"" + command + "\". Scrie !help dacă ai nevoie de ajutor!";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message("Vino aici, tu!").then(new Action("îl îmbrățișează pe " + apiUser.getUserName()));
    }
    ...
    public String featureRankRestricted(String feature, int minRank, OsuApiUser user) {
        return "Îmi pare rău, momentan " + feature
                + " este valabil(ă) numai pentru jucătorii care au trecut de rank-ul " + minRank + ".";
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return "Îmi pare rău, dar \"" + invalid + "\" nu poate fi procesat. Încearcă: " + choices + "!";
    }
