...
public class Norwegian extends AbstractMutableLanguage {
    ...
    public GameChatResponse welcomeUser(OsuApiUser apiUser, long inactiveTime) {
        if (inactiveTime < 60 * 1000) {
            ...
            return new Message(apiUser.getUserName() + "...")
                    ...
                    .then(new Message(
                            "Det er godt å ha deg tilbake. Kan jeg tilfredstille deg i en anbefaling fra meg?"));
        } else {
            String[] messages = {
    ...
    public String unknownCommand(String command) {
        return "Unkjent Kommando \"" + command + "\". Skriv !help om du trenger hjelp.";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message("Du! Kom her!").then(new Action("klem " + apiUser.getUserName()));
    }
    ...
    public String featureRankRestricted(String feature, int minRank, OsuApiUser user) {
        return "Beklager, for øyeblikket er " + feature + " bare tilgjengelig for spillere som har nådd rank: "
                + minRank + ".";
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return "Beklager, men \"" + invalid + "\" kan ikke beregnes. Prøv disse: " + choices + "!";
    }
    ...
    public String apiTimeoutException() {
        ...
        final String message =
                "osu! serverene er ikke så raske akkurat nå, så det er ingenting jeg kan gjøre for deg i dette øyeblikket. ";
        return message
