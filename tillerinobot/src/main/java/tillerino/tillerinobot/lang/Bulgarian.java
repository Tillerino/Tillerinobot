...
public class Bulgarian extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return " Непозната команда \"" + command + "\". Напиши !help , в случай че ти трябва помощ!";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message(" Ела тук!").then(new Action(" Прегръдка за " + apiUser.getUserName()));
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return " Съжаляам, но \"" + invalid + "\" не можа да се изпълни. Опитай: " + choices + "!";
    }
