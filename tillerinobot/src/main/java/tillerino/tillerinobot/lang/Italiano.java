...
public class Italiano extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "Comando sconosciuto \"" + command + "\". Scrivi !help se hai bisogno di aiuto!";
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return "Mi spiace, ma \"" + invalid + "\" non funziona. Prova questi: " + choices + "!";
    }
    ...
    public String apiTimeoutException() {
        ...
        final String message =
                "I server di osu! sono super lenti per ora, quindi non c'è nulla che posso fare al momento. ";
        return message
