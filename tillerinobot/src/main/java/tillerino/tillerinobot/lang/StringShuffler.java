 ...
 */
/**
 * Device to permanently shuffle an array of Strings while the size of this object is independent of the number of
 * strings. This is accomplished by saving the seed for shuffling the array and shuffling it every time a String is
 * requested instead of shuffling it once.
 */
