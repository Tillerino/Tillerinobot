...
public class Default extends AbstractMutableLanguage {
    ...
    public String unknownCommand(String command) {
        return "Unknown command \"" + command + "\". Type !help if you need help!";
    }
    ...
    public GameChatResponse hug(OsuApiUser apiUser) {
        return new Message("Come here, you!").then(new Action("hugs " + apiUser.getUserName()));
    }
    ...
    public String invalidChoice(String invalid, String choices) {
        return "I'm sorry, but \"" + invalid + "\" does not compute. Try these: " + choices + "!";
    }
    ...
    public String apiTimeoutException() {
        ...
        final String message =
                "The osu! servers are super slow right now, so there's nothing I can do for you at this moment. ";
        return message
