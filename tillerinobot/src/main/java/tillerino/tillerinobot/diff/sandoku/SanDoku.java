...
/** Client for an instance of https://github.com/omkelderman/SanDoku */
public interface SanDoku {
    ...
    static ProcessorApi defaultClient(URI baseUri) {
        return WebResourceFactory.newResource(
                ProcessorApi.class, JerseyClientBuilder.createClient().target(baseUri));
    }
    ...
    class SanDokuTestImpl implements ProcessorApi {
        ...
        public DiffResult processorCalcDiff(
                Integer mode, Integer mods, Boolean storeResultInCacheForPpCalc, byte[] beatmap) {
