...
Since it came out, [oppai](https://github.com/Francesco149/oppai) (or rather [a fork](https://github.com/Francesco149/koohii)) is being used to make beatmap difficulty calculation more stable and to calculate difficulties for unranked beatmaps.
