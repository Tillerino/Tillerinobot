...
public abstract class GameChatEvent {
    ...
    /**
     * This is meta information which is collected throughout the phases. Since this information is mutable, we tuck it
     * away in this field. This doesn't make the entire object immutable, but at least we have a clear overview of there
     * the mutability lies.
     */
