...
public class IrcContainer {
    ...
    public static final CustomTestContainer TILLERINOBOT_IRC = new CustomTestContainer(
                    new File("../../Tillerinobot/tillerinobot-irc/target/release/main").exists()
                            ? base.withFileFromFile(
                                    "target/release/main",
                                    new File("../../Tillerinobot/tillerinobot-irc/target/release/main"))
                            : base)
            .withNetwork(NETWORK)
